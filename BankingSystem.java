...
public class BankingSystem extends JFrame {
    ...
    public BankingSystem() {
        ...
        sidebarPanel.setBackground(new Color(30, 144, 255)); // dodger blue
        ...
        for (String item : menuItems) {
            ...
            button.setBackground(new Color(25, 25, 112)); // midnight blue
    ...
    private JPanel createAccountsPanel() {
        ...
        accountsPanel.setBackground(new Color(250, 250, 250)); // off white
        ...
        accountsLabel.setForeground(new Color(25, 25, 112)); // midnight blue
    ...
    private JPanel createTransfersPanel() {
        ...
        transfersPanel.setBackground(new Color(245, 255, 250)); // very light green
    ...
    private JPanel createDashboardPanel() {
        ...
        dashboardPanel.setBackground(new Color(255, 250, 250)); // very light pink
    ...
    private JPanel createCreateAccountPanel() {
        ...
        panel.setBackground(new Color(255, 250, 240)); // pastel floral white
    ...
    private JPanel createSettingsPanel() {
        ...
        settingsPanel.setBackground(new Color(255, 250, 240)); // pastel floral white
    ...
    private void updateBalanceLabel() {
        ...
        updateAccountDetails(); // Ensure account panel balance is updated as well
    }

    private void updateAccountDetails() {
        // Update the account details panel if visible
        Component comp = mainContentPanel.getComponent(1); // Accounts panel index (2nd panel)
