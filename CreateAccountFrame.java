...
public class CreateAccountFrame extends JFrame {
    ...
    public CreateAccountFrame() {
        ...
        // Thank you message
        // Removed thank you label to avoid overlap with buttons
...
//        add(thankYouLabel, BorderLayout.PAGE_END);
        ...
        backButton.addActionListener(e -> {
            // Open BankAuthentication and close this frame
        ...
        saveButton.addActionListener(e -> {
            // Validate form fields (simple non-empty check)
            Component[] components = formPanel.getComponents();
            boolean valid = true;
            for (int i = 1; i < components.length; i += 2) { // check input fields only
            ...
            // After save, open BankAuthentication and close this frame
            BankAuthentication authFrame = new BankAuthentication();
            authFrame.setVisible(true);
            this.dispose();
        });
